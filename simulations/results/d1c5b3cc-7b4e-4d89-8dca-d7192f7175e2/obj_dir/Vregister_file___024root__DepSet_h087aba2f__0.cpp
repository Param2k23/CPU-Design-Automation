...
VL_INLINE_OPT void Vregister_file___024root___ico_sequent__TOP__0(Vregister_file___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelfRef.rdata1 = ((0U == (IData)(vlSelfRef.rs1))
                         ? 0U : vlSelfRef.register_file__DOT__regs
                        [vlSelfRef.rs1]);
    vlSelfRef.rdata2 = ((0U == (IData)(vlSelfRef.rs2))
                         ? 0U : vlSelfRef.register_file__DOT__regs
                        [vlSelfRef.rs2]);
}
...
VL_INLINE_OPT void Vregister_file___024root___nba_sequent__TOP__0(Vregister_file___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Init
    IData/*31:0*/ __VdlyVal__register_file__DOT__regs__v0;
    __VdlyVal__register_file__DOT__regs__v0 = 0;
    CData/*4:0*/ __VdlyDim0__register_file__DOT__regs__v0;
    __VdlyDim0__register_file__DOT__regs__v0 = 0;
    CData/*0:0*/ __VdlySet__register_file__DOT__regs__v0;
    __VdlySet__register_file__DOT__regs__v0 = 0;
    // Body
    __VdlySet__register_file__DOT__regs__v0 = 0U;
    if (((IData)(vlSelfRef.we) & (0U != (IData)(vlSelfRef.rd)))) {
        __VdlyVal__register_file__DOT__regs__v0 = vlSelfRef.wdata;
        __VdlyDim0__register_file__DOT__regs__v0 = vlSelfRef.rd;
        __VdlySet__register_file__DOT__regs__v0 = 1U;
    }
    if (__VdlySet__register_file__DOT__regs__v0) {
        vlSelfRef.register_file__DOT__regs[__VdlyDim0__register_file__DOT__regs__v0] 
            = __VdlyVal__register_file__DOT__regs__v0;
    }
    vlSelfRef.rdata1 = ((0U == (IData)(vlSelfRef.rs1))
                         ? 0U : vlSelfRef.register_file__DOT__regs
                        [vlSelfRef.rs1]);
...
#endif
            VL_FATAL_MT("/app/rtl/register_file/register_file.sv", 1, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("/app/rtl/register_file/register_file.sv", 1, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("/app/rtl/register_file/register_file.sv", 1, "", "Active region did not converge.");
            }
